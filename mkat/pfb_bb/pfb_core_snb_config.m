...
function pfb_core_snb_config(this_block)

  % Revision History:
  %
  %   24-Mar-2015  (13:15 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/paulp/projects/code/shiny-octo-wookie/mkat/pfb_bb/pfb_core_snb.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('pfb_core_snb');
...
%   this_block.tagAsCombinational;
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('pfb_core_snb.vhd');
