...
function pfb_core_config(this_block)
  ...
  % Revision History:
  %
  %   24-Mar-2015  (13:20 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/paulp/projects/code/shiny-octo-wookie/mkat/pfb_bb/pfb_core.vhd
  %
  %
...
%   this_block.tagAsCombinational;
  ...
  of_out_port.setType('UFix_2_0');
  pol0_out_port = this_block.port('pol0_out');
  pol0_out_port.setType('UFix_144_0');
  pol1_out_port = this_block.port('pol1_out');
  pol1_out_port.setType('UFix_144_0');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol0_in').width ~= 80);
      this_block.setError('Input data type for port "pol0_in" must have width=80.');
    end

    if (this_block.port('pol1_in').width ~= 80);
      this_block.setError('Input data type for port "pol1_in" must have width=80.');
    end
