...
function pfb_core_snbxfft32_config(this_block)

  % Revision History:
  %
  %   24-Mar-2015  (14:56 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/paulp/projects/code/shiny-octo-wookie/mkat/pfb_bb/pfb_core_snbxfft32.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('pfb_core_snbxfft32');
...
%   this_block.tagAsCombinational;
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('pfb_core_snbxfft32.vhd');
